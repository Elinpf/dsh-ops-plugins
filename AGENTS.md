...
- `ops-prompts` — prompt channel plugin: registers methodology sections (static system-prompt text) and reminders (pre-step check functions that inject ephemeral prompts). Carries no business content itself.
